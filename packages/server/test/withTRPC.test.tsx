...
describe('withTRPC()', () => {
  ...
  xtest('useQuery - ssr batching', async () => {
    // @ts-ignore
    const { window } = global;
  ...
  xdescribe('`enabled: false` on query during ssr', () => {
    describe('useQuery', () => {
